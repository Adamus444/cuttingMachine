...
#define cpu_map_h
  ...
  #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits, MANUAL CHANGE except Z
  ...
  #define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits, MANUAL CHANGE except Z
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // MANUAL CHANGE, i changed the dual bits to d4 and d7
      ...
      #define DUAL_STEP_BIT       4  // Uno Digital Pin 4 MANUAL CHANGE
      #define STEP_MASK_DUAL      ((1<<DUAL_STEP_BIT))
      #define DIRECTION_DDR_DUAL  DDRD
      #define DIRECTION_PORT_DUAL PORTD
      #define DUAL_DIRECTION_BIT  7  // Uno Digital Pin 7 MANUAL CHANGE
      ...
      #define LIMIT_MASK        ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)|(1<<DUAL_LIMIT_BIT))
