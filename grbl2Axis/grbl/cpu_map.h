...
#define cpu_map_h
  ...
  #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)) // All step bits, MANUAL CHANGE except Z
  ...
  #define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)) // All direction bits, MANUAL CHANGE except Z
