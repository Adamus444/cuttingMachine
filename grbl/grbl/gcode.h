...
#define MODAL_GROUP_M10 15 // [] MANUAL ADDITION
#define USER_MCODE_TEMP 101 // [M101] MANUAL ADDITION
                            // im trying to control the damn temperature of the wire
#define USER_MCODE_KNOCK 102 // MANUAL ADDITION
                             // make the 360 to knock down the cut foam circles
...
typedef struct {
  ...
  gc_modal_t modal;
  gc_values_t values;
  uint8_t user_mcode; // MANUAL ADDITION
} parser_block_t;
